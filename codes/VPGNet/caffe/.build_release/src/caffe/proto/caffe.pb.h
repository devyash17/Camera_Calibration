...
class FixedPoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.FixedPoint) */ {
 public:
  FixedPoint();
  virtual ~FixedPoint();
  ...
  inline FixedPoint* New() const { return New(NULL); }

  FixedPoint* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static FixedPoint* default_instance_;
};
// -------------------------------------------------------------------

class CarBoundingBox : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.CarBoundingBox) */ {
 public:
  CarBoundingBox();
  virtual ~CarBoundingBox();

  CarBoundingBox(const CarBoundingBox& from);

  inline CarBoundingBox& operator=(const CarBoundingBox& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CarBoundingBox& default_instance();

  void Swap(CarBoundingBox* other);

  // implements Message ----------------------------------------------

  inline CarBoundingBox* New() const { return New(NULL); }

  CarBoundingBox* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CarBoundingBox& from);
  void MergeFrom(const CarBoundingBox& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(CarBoundingBox* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // repeated .caffe.FixedPoint poly_mask = 6;
  int poly_mask_size() const;
  void clear_poly_mask();
  static const int kPolyMaskFieldNumber = 6;
  const ::caffe::FixedPoint& poly_mask(int index) const;
  ::caffe::FixedPoint* mutable_poly_mask(int index);
  ::caffe::FixedPoint* add_poly_mask();
  ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >*
      mutable_poly_mask();
  const ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >&
      poly_mask() const;

  // repeated .caffe.FixedPoint ellipse_mask = 7;
  int ellipse_mask_size() const;
  void clear_ellipse_mask();
  static const int kEllipseMaskFieldNumber = 7;
  const ::caffe::FixedPoint& ellipse_mask(int index) const;
  ::caffe::FixedPoint* mutable_ellipse_mask(int index);
  ::caffe::FixedPoint* add_ellipse_mask();
  ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >*
      mutable_ellipse_mask();
  const ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >&
      ellipse_mask() const;
 ...
 private:
  ...
  float xmax_;
  float ymax_;
  ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint > poly_mask_;
  ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint > ellipse_mask_;
  ...
  void InitAsDefaultInstance();
  static CarBoundingBox* default_instance_;
};
// -------------------------------------------------------------------

class VanishingPoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.VanishingPoint) */ {
 public:
  VanishingPoint();
  virtual ~VanishingPoint();

  VanishingPoint(const VanishingPoint& from);

  inline VanishingPoint& operator=(const VanishingPoint& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const VanishingPoint& default_instance();

  void Swap(VanishingPoint* other);

  // implements Message ----------------------------------------------

  inline VanishingPoint* New() const { return New(NULL); }

  VanishingPoint* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const VanishingPoint& from);
  void MergeFrom(const VanishingPoint& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(VanishingPoint* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static VanishingPoint* default_instance_;
};
// -------------------------------------------------------------------

class DrivingData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DrivingData) */ {
 public:
  DrivingData();
  virtual ~DrivingData();

  DrivingData(const DrivingData& from);

  inline DrivingData& operator=(const DrivingData& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const DrivingData& default_instance();

  void Swap(DrivingData* other);

  // implements Message ----------------------------------------------

  inline DrivingData* New() const { return New(NULL); }

  DrivingData* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const DrivingData& from);
  void MergeFrom(const DrivingData& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(DrivingData* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // optional .caffe.Datum car_image_datum = 1;
  bool has_car_image_datum() const;
  void clear_car_image_datum();
  static const int kCarImageDatumFieldNumber = 1;
  const ::caffe::Datum& car_image_datum() const;
  ::caffe::Datum* mutable_car_image_datum();
  ::caffe::Datum* release_car_image_datum();
  void set_allocated_car_image_datum(::caffe::Datum* car_image_datum);

  // optional string car_img_source = 2;
  bool has_car_img_source() const;
  void clear_car_img_source();
  static const int kCarImgSourceFieldNumber = 2;
  const ::std::string& car_img_source() const;
  void set_car_img_source(const ::std::string& value);
  void set_car_img_source(const char* value);
  void set_car_img_source(const char* value, size_t size);
  ::std::string* mutable_car_img_source();
  ::std::string* release_car_img_source();
  void set_allocated_car_img_source(::std::string* car_img_source);

  // optional .caffe.Datum car_mask_datum = 3;
  bool has_car_mask_datum() const;
  void clear_car_mask_datum();
  static const int kCarMaskDatumFieldNumber = 3;
  const ::caffe::Datum& car_mask_datum() const;
  ::caffe::Datum* mutable_car_mask_datum();
  ::caffe::Datum* release_car_mask_datum();
  void set_allocated_car_mask_datum(::caffe::Datum* car_mask_datum);

  // optional string car_mask_source = 4;
  bool has_car_mask_source() const;
  void clear_car_mask_source();
  static const int kCarMaskSourceFieldNumber = 4;
  const ::std::string& car_mask_source() const;
  void set_car_mask_source(const ::std::string& value);
  void set_car_mask_source(const char* value);
  void set_car_mask_source(const char* value, size_t size);
  ::std::string* mutable_car_mask_source();
  ::std::string* release_car_mask_source();
  void set_allocated_car_mask_source(::std::string* car_mask_source);

  // repeated .caffe.CarBoundingBox car_boxes = 5;
  int car_boxes_size() const;
  void clear_car_boxes();
  static const int kCarBoxesFieldNumber = 5;
  const ::caffe::CarBoundingBox& car_boxes(int index) const;
  ::caffe::CarBoundingBox* mutable_car_boxes(int index);
  ::caffe::CarBoundingBox* add_car_boxes();
  ::google::protobuf::RepeatedPtrField< ::caffe::CarBoundingBox >*
      mutable_car_boxes();
  const ::google::protobuf::RepeatedPtrField< ::caffe::CarBoundingBox >&
      car_boxes() const;

  // repeated .caffe.VanishingPoint vanishing_point = 6;
  int vanishing_point_size() const;
  void clear_vanishing_point();
  static const int kVanishingPointFieldNumber = 6;
  const ::caffe::VanishingPoint& vanishing_point(int index) const;
  ::caffe::VanishingPoint* mutable_vanishing_point(int index);
  ::caffe::VanishingPoint* add_vanishing_point();
  ::google::protobuf::RepeatedPtrField< ::caffe::VanishingPoint >*
      mutable_vanishing_point();
  const ::google::protobuf::RepeatedPtrField< ::caffe::VanishingPoint >&
      vanishing_point() const;

  // @@protoc_insertion_point(class_scope:caffe.DrivingData)
 private:
  inline void set_has_car_image_datum();
  inline void clear_has_car_image_datum();
  inline void set_has_car_img_source();
  inline void clear_has_car_img_source();
  inline void set_has_car_mask_datum();
  inline void clear_has_car_mask_datum();
  inline void set_has_car_mask_source();
  inline void clear_has_car_mask_source();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::caffe::Datum* car_image_datum_;
  ::google::protobuf::internal::ArenaStringPtr car_img_source_;
  ::caffe::Datum* car_mask_datum_;
  ::google::protobuf::internal::ArenaStringPtr car_mask_source_;
  ::google::protobuf::RepeatedPtrField< ::caffe::CarBoundingBox > car_boxes_;
  ::google::protobuf::RepeatedPtrField< ::caffe::VanishingPoint > vanishing_point_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static DrivingData* default_instance_;
};
// -------------------------------------------------------------------
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  // optional .caffe.TilingParameter tiling_param = 500;
  bool has_tiling_param() const;
  void clear_tiling_param();
  static const int kTilingParamFieldNumber = 500;
  const ::caffe::TilingParameter& tiling_param() const;
  ::caffe::TilingParameter* mutable_tiling_param();
  ::caffe::TilingParameter* release_tiling_param();
  void set_allocated_tiling_param(::caffe::TilingParameter* tiling_param);

  // optional .caffe.DriveDataParameter drive_data_param = 501;
  bool has_drive_data_param() const;
  void clear_drive_data_param();
  static const int kDriveDataParamFieldNumber = 501;
  const ::caffe::DriveDataParameter& drive_data_param() const;
  ::caffe::DriveDataParameter* mutable_drive_data_param();
  ::caffe::DriveDataParameter* release_drive_data_param();
  void set_allocated_drive_data_param(::caffe::DriveDataParameter* drive_data_param);
 ...
 private:
  ...
  inline void set_has_tiling_param();
  inline void clear_has_tiling_param();
  inline void set_has_drive_data_param();
  inline void clear_has_drive_data_param();
  ...
  ::caffe::TilingParameter* tiling_param_;
  ::caffe::DriveDataParameter* drive_data_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class TilingParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.TilingParameter) */ {
 public:
  TilingParameter();
  virtual ~TilingParameter();

  TilingParameter(const TilingParameter& from);

  inline TilingParameter& operator=(const TilingParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const TilingParameter& default_instance();

  void Swap(TilingParameter* other);

  // implements Message ----------------------------------------------

  inline TilingParameter* New() const { return New(NULL); }

  TilingParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const TilingParameter& from);
  void MergeFrom(const TilingParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TilingParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // optional int32 tile_dim = 1;
  bool has_tile_dim() const;
  void clear_tile_dim();
  static const int kTileDimFieldNumber = 1;
  ::google::protobuf::int32 tile_dim() const;
  void set_tile_dim(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:caffe.TilingParameter)
 private:
  inline void set_has_tile_dim();
  inline void clear_has_tile_dim();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::int32 tile_dim_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static TilingParameter* default_instance_;
};
// -------------------------------------------------------------------

class DriveDataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DriveDataParameter) */ {
 public:
  DriveDataParameter();
  virtual ~DriveDataParameter();

  DriveDataParameter(const DriveDataParameter& from);

  inline DriveDataParameter& operator=(const DriveDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const DriveDataParameter& default_instance();

  void Swap(DriveDataParameter* other);

  // implements Message ----------------------------------------------

  inline DriveDataParameter* New() const { return New(NULL); }

  DriveDataParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const DriveDataParameter& from);
  void MergeFrom(const DriveDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(DriveDataParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // optional float shrink_prob_factor = 1 [default = 1];
  bool has_shrink_prob_factor() const;
  void clear_shrink_prob_factor();
  static const int kShrinkProbFactorFieldNumber = 1;
  float shrink_prob_factor() const;
  void set_shrink_prob_factor(float value);

  // optional float unrecognize_factor = 2 [default = 0.9];
  bool has_unrecognize_factor() const;
  void clear_unrecognize_factor();
  static const int kUnrecognizeFactorFieldNumber = 2;
  float unrecognize_factor() const;
  void set_unrecognize_factor(float value);

  // optional uint32 crop_num = 3 [default = 4];
  bool has_crop_num() const;
  void clear_crop_num();
  static const int kCropNumFieldNumber = 3;
  ::google::protobuf::uint32 crop_num() const;
  void set_crop_num(::google::protobuf::uint32 value);

  // optional float random_crop_ratio = 4 [default = 0];
  bool has_random_crop_ratio() const;
  void clear_random_crop_ratio();
  static const int kRandomCropRatioFieldNumber = 4;
  float random_crop_ratio() const;
  void set_random_crop_ratio(float value);

  // optional float resize = 5 [default = 1];
  bool has_resize() const;
  void clear_resize();
  static const int kResizeFieldNumber = 5;
  float resize() const;
  void set_resize(float value);
  ...
  // optional uint32 cropped_height = 7 [default = 480];
  bool has_cropped_height() const;
  void clear_cropped_height();
  static const int kCroppedHeightFieldNumber = 7;
  ::google::protobuf::uint32 cropped_height() const;
  void set_cropped_height(::google::protobuf::uint32 value);

  // optional uint32 cropped_width = 8 [default = 640];
  bool has_cropped_width() const;
  void clear_cropped_width();
  static const int kCroppedWidthFieldNumber = 8;
  ::google::protobuf::uint32 cropped_width() const;
  void set_cropped_width(::google::protobuf::uint32 value);

  // optional int32 tiling_width = 9 [default = 20];
  bool has_tiling_width() const;
  void clear_tiling_width();
  static const int kTilingWidthFieldNumber = 9;
  ::google::protobuf::int32 tiling_width() const;
  void set_tiling_width(::google::protobuf::int32 value);

  // optional int32 tiling_height = 10 [default = 15];
  bool has_tiling_height() const;
  void clear_tiling_height();
  static const int kTilingHeightFieldNumber = 10;
  ::google::protobuf::int32 tiling_height() const;
  void set_tiling_height(::google::protobuf::int32 value);

  // optional int32 label_resolution = 11 [default = 8];
  bool has_label_resolution() const;
  void clear_label_resolution();
  static const int kLabelResolutionFieldNumber = 11;
  ::google::protobuf::int32 label_resolution() const;
  void set_label_resolution(::google::protobuf::int32 value);

  // optional int32 catalog_resolution = 12 [default = 2];
  bool has_catalog_resolution() const;
  void clear_catalog_resolution();
  static const int kCatalogResolutionFieldNumber = 12;
  ::google::protobuf::int32 catalog_resolution() const;
  void set_catalog_resolution(::google::protobuf::int32 value);

  // optional int32 catalog_number = 13 [default = 150];
  bool has_catalog_number() const;
  void clear_catalog_number();
  static const int kCatalogNumberFieldNumber = 13;
  ::google::protobuf::int32 catalog_number() const;
  void set_catalog_number(::google::protobuf::int32 value);

  // optional float resize_max = 14 [default = 5];
  bool has_resize_max() const;
  void clear_resize_max();
  static const int kResizeMaxFieldNumber = 14;
  float resize_max() const;
  void set_resize_max(float value);

  // optional float resize_min = 15 [default = 0.1];
  bool has_resize_min() const;
  void clear_resize_min();
  static const int kResizeMinFieldNumber = 15;
  float resize_min() const;
  void set_resize_min(float value);

  // optional float reco_max = 16 [default = 170];
  bool has_reco_max() const;
  void clear_reco_max();
  static const int kRecoMaxFieldNumber = 16;
  float reco_max() const;
  void set_reco_max(float value);

  // optional float reco_min = 17 [default = 40];
  bool has_reco_min() const;
  void clear_reco_min();
  static const int kRecoMinFieldNumber = 17;
  float reco_min() const;
  void set_reco_min(float value);

  // optional float train_max = 18 [default = 200];
  bool has_train_max() const;
  void clear_train_max();
  static const int kTrainMaxFieldNumber = 18;
  float train_max() const;
  void set_train_max(float value);

  // optional float train_min = 19 [default = 20];
  bool has_train_min() const;
  void clear_train_min();
  static const int kTrainMinFieldNumber = 19;
  float train_min() const;
  void set_train_min(float value);

  // optional string genlist_file = 20 [default = ""];
  bool has_genlist_file() const;
  void clear_genlist_file();
  static const int kGenlistFileFieldNumber = 20;
  const ::std::string& genlist_file() const;
  void set_genlist_file(const ::std::string& value);
  void set_genlist_file(const char* value);
  void set_genlist_file(const char* value, size_t size);
  ::std::string* mutable_genlist_file();
  ::std::string* release_genlist_file();
  void set_allocated_genlist_file(::std::string* genlist_file);

  // optional float gen_rate = 21 [default = 0.5];
  bool has_gen_rate() const;
  void clear_gen_rate();
  static const int kGenRateFieldNumber = 21;
  float gen_rate() const;
  void set_gen_rate(float value);

  // optional float blur_max = 22 [default = 15];
  bool has_blur_max() const;
  void clear_blur_max();
  static const int kBlurMaxFieldNumber = 22;
  float blur_max() const;
  void set_blur_max(float value);

  // optional float noise_max = 23 [default = 0.5];
  bool has_noise_max() const;
  void clear_noise_max();
  static const int kNoiseMaxFieldNumber = 23;
  float noise_max() const;
  void set_noise_max(float value);

  // optional float gamma_max = 24 [default = 0.69314718];
  bool has_gamma_max() const;
  void clear_gamma_max();
  static const int kGammaMaxFieldNumber = 24;
  float gamma_max() const;
  void set_gamma_max(float value);

  // optional float k_max = 25 [default = 0.1];
  bool has_k_max() const;
  void clear_k_max();
  static const int kKMaxFieldNumber = 25;
  float k_max() const;
  void set_k_max(float value);

  // optional float y0_max = 26 [default = 0.1];
  bool has_y0_max() const;
  void clear_y0_max();
  static const int kY0MaxFieldNumber = 26;
  float y0_max() const;
  void set_y0_max(float value);

  // optional float shrink_max = 27 [default = 0.5];
  bool has_shrink_max() const;
  void clear_shrink_max();
  static const int kShrinkMaxFieldNumber = 27;
  float shrink_max() const;
  void set_shrink_max(float value);

  // optional float slip_max = 28 [default = 0.2];
  bool has_slip_max() const;
  void clear_slip_max();
  static const int kSlipMaxFieldNumber = 28;
  float slip_max() const;
  void set_slip_max(float value);

  // optional float gen_scale = 29 [default = 1.5];
  bool has_gen_scale() const;
  void clear_gen_scale();
  static const int kGenScaleFieldNumber = 29;
  float gen_scale() const;
  void set_gen_scale(float value);

  // optional bool use_mask = 30 [default = false];
  bool has_use_mask() const;
  void clear_use_mask();
  static const int kUseMaskFieldNumber = 30;
  bool use_mask() const;
  void set_use_mask(bool value);

  // @@protoc_insertion_point(class_scope:caffe.DriveDataParameter)
 private:
  inline void set_has_shrink_prob_factor();
  inline void clear_has_shrink_prob_factor();
  inline void set_has_unrecognize_factor();
  inline void clear_has_unrecognize_factor();
  inline void set_has_crop_num();
  inline void clear_has_crop_num();
  inline void set_has_random_crop_ratio();
  inline void clear_has_random_crop_ratio();
  inline void set_has_resize();
  inline void clear_has_resize();
  inline void set_has_scale();
  inline void clear_has_scale();
  inline void set_has_cropped_height();
  inline void clear_has_cropped_height();
  inline void set_has_cropped_width();
  inline void clear_has_cropped_width();
  inline void set_has_tiling_width();
  inline void clear_has_tiling_width();
  inline void set_has_tiling_height();
  inline void clear_has_tiling_height();
  inline void set_has_label_resolution();
  inline void clear_has_label_resolution();
  inline void set_has_catalog_resolution();
  inline void clear_has_catalog_resolution();
  inline void set_has_catalog_number();
  inline void clear_has_catalog_number();
  inline void set_has_resize_max();
  inline void clear_has_resize_max();
  inline void set_has_resize_min();
  inline void clear_has_resize_min();
  inline void set_has_reco_max();
  inline void clear_has_reco_max();
  inline void set_has_reco_min();
  inline void clear_has_reco_min();
  inline void set_has_train_max();
  inline void clear_has_train_max();
  inline void set_has_train_min();
  inline void clear_has_train_min();
  inline void set_has_genlist_file();
  inline void clear_has_genlist_file();
  inline void set_has_gen_rate();
  inline void clear_has_gen_rate();
  inline void set_has_blur_max();
  inline void clear_has_blur_max();
  inline void set_has_noise_max();
  inline void clear_has_noise_max();
  inline void set_has_gamma_max();
  inline void clear_has_gamma_max();
  inline void set_has_k_max();
  inline void clear_has_k_max();
  inline void set_has_y0_max();
  inline void clear_has_y0_max();
  inline void set_has_shrink_max();
  inline void clear_has_shrink_max();
  inline void set_has_slip_max();
  inline void clear_has_slip_max();
  inline void set_has_gen_scale();
  inline void clear_has_gen_scale();
  inline void set_has_use_mask();
  inline void clear_has_use_mask();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  float shrink_prob_factor_;
  float unrecognize_factor_;
  ::google::protobuf::uint32 crop_num_;
  float random_crop_ratio_;
  float resize_;
  float scale_;
  ::google::protobuf::uint32 cropped_height_;
  ::google::protobuf::uint32 cropped_width_;
  ::google::protobuf::int32 tiling_width_;
  ::google::protobuf::int32 tiling_height_;
  ::google::protobuf::int32 label_resolution_;
  ::google::protobuf::int32 catalog_resolution_;
  ::google::protobuf::int32 catalog_number_;
  float resize_max_;
  float resize_min_;
  float reco_max_;
  float reco_min_;
  float train_max_;
  ::google::protobuf::internal::ArenaStringPtr genlist_file_;
  float train_min_;
  float gen_rate_;
  float blur_max_;
  float noise_max_;
  ...
  void InitAsDefaultInstance();
  static DriveDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional float x = 1;
inline bool FixedPoint::has_x() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void FixedPoint::set_has_x() {
  _has_bits_[0] |= 0x00000001u;
}
inline void FixedPoint::clear_has_x() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void FixedPoint::clear_x() {
  x_ = 0;
  clear_has_x();
}
inline float FixedPoint::x() const {
  // @@protoc_insertion_point(field_get:caffe.FixedPoint.x)
  return x_;
}
inline void FixedPoint::set_x(float value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:caffe.FixedPoint.x)
}

// optional float y = 2;
inline bool FixedPoint::has_y() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void FixedPoint::set_has_y() {
  _has_bits_[0] |= 0x00000002u;
}
inline void FixedPoint::clear_has_y() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void FixedPoint::clear_y() {
  y_ = 0;
  clear_has_y();
}
inline float FixedPoint::y() const {
  // @@protoc_insertion_point(field_get:caffe.FixedPoint.y)
  return y_;
}
inline void FixedPoint::set_y(float value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:caffe.FixedPoint.y)
}
...
// optional float xmin = 1;
inline bool CarBoundingBox::has_xmin() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CarBoundingBox::set_has_xmin() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CarBoundingBox::clear_has_xmin() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CarBoundingBox::clear_xmin() {
  xmin_ = 0;
  clear_has_xmin();
}
inline float CarBoundingBox::xmin() const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.xmin)
  return xmin_;
}
inline void CarBoundingBox::set_xmin(float value) {
  set_has_xmin();
  xmin_ = value;
  // @@protoc_insertion_point(field_set:caffe.CarBoundingBox.xmin)
}

// optional float ymin = 2;
inline bool CarBoundingBox::has_ymin() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void CarBoundingBox::set_has_ymin() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CarBoundingBox::clear_has_ymin() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void CarBoundingBox::clear_ymin() {
  ymin_ = 0;
  clear_has_ymin();
}
inline float CarBoundingBox::ymin() const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.ymin)
  return ymin_;
}
inline void CarBoundingBox::set_ymin(float value) {
  set_has_ymin();
  ymin_ = value;
  // @@protoc_insertion_point(field_set:caffe.CarBoundingBox.ymin)
}

// optional float xmax = 3;
inline bool CarBoundingBox::has_xmax() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void CarBoundingBox::set_has_xmax() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CarBoundingBox::clear_has_xmax() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void CarBoundingBox::clear_xmax() {
  xmax_ = 0;
  clear_has_xmax();
}
inline float CarBoundingBox::xmax() const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.xmax)
  return xmax_;
}
inline void CarBoundingBox::set_xmax(float value) {
  set_has_xmax();
  xmax_ = value;
  // @@protoc_insertion_point(field_set:caffe.CarBoundingBox.xmax)
}

// optional float ymax = 4;
inline bool CarBoundingBox::has_ymax() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void CarBoundingBox::set_has_ymax() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CarBoundingBox::clear_has_ymax() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void CarBoundingBox::clear_ymax() {
  ymax_ = 0;
  clear_has_ymax();
}
inline float CarBoundingBox::ymax() const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.ymax)
  return ymax_;
}
inline void CarBoundingBox::set_ymax(float value) {
  set_has_ymax();
  ymax_ = value;
  // @@protoc_insertion_point(field_set:caffe.CarBoundingBox.ymax)
}

// optional int32 type = 5;
inline bool CarBoundingBox::has_type() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void CarBoundingBox::set_has_type() {
  _has_bits_[0] |= 0x00000010u;
}
inline void CarBoundingBox::clear_has_type() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void CarBoundingBox::clear_type() {
  type_ = 0;
  clear_has_type();
}
inline ::google::protobuf::int32 CarBoundingBox::type() const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.type)
  return type_;
}
inline void CarBoundingBox::set_type(::google::protobuf::int32 value) {
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:caffe.CarBoundingBox.type)
}

// repeated .caffe.FixedPoint poly_mask = 6;
inline int CarBoundingBox::poly_mask_size() const {
  return poly_mask_.size();
}
inline void CarBoundingBox::clear_poly_mask() {
  poly_mask_.Clear();
}
inline const ::caffe::FixedPoint& CarBoundingBox::poly_mask(int index) const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.poly_mask)
  return poly_mask_.Get(index);
}
inline ::caffe::FixedPoint* CarBoundingBox::mutable_poly_mask(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.CarBoundingBox.poly_mask)
  return poly_mask_.Mutable(index);
}
inline ::caffe::FixedPoint* CarBoundingBox::add_poly_mask() {
  // @@protoc_insertion_point(field_add:caffe.CarBoundingBox.poly_mask)
  return poly_mask_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >*
CarBoundingBox::mutable_poly_mask() {
  // @@protoc_insertion_point(field_mutable_list:caffe.CarBoundingBox.poly_mask)
  return &poly_mask_;
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >&
CarBoundingBox::poly_mask() const {
  // @@protoc_insertion_point(field_list:caffe.CarBoundingBox.poly_mask)
  return poly_mask_;
}

// repeated .caffe.FixedPoint ellipse_mask = 7;
inline int CarBoundingBox::ellipse_mask_size() const {
  return ellipse_mask_.size();
}
inline void CarBoundingBox::clear_ellipse_mask() {
  ellipse_mask_.Clear();
}
inline const ::caffe::FixedPoint& CarBoundingBox::ellipse_mask(int index) const {
  // @@protoc_insertion_point(field_get:caffe.CarBoundingBox.ellipse_mask)
  return ellipse_mask_.Get(index);
}
inline ::caffe::FixedPoint* CarBoundingBox::mutable_ellipse_mask(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.CarBoundingBox.ellipse_mask)
  return ellipse_mask_.Mutable(index);
}
inline ::caffe::FixedPoint* CarBoundingBox::add_ellipse_mask() {
  // @@protoc_insertion_point(field_add:caffe.CarBoundingBox.ellipse_mask)
  return ellipse_mask_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >*
CarBoundingBox::mutable_ellipse_mask() {
  // @@protoc_insertion_point(field_mutable_list:caffe.CarBoundingBox.ellipse_mask)
  return &ellipse_mask_;
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::FixedPoint >&
CarBoundingBox::ellipse_mask() const {
  // @@protoc_insertion_point(field_list:caffe.CarBoundingBox.ellipse_mask)
  return ellipse_mask_;
}
...
// optional bool valid = 1;
inline bool VanishingPoint::has_valid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void VanishingPoint::set_has_valid() {
  _has_bits_[0] |= 0x00000001u;
}
inline void VanishingPoint::clear_has_valid() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void VanishingPoint::clear_valid() {
  valid_ = false;
  clear_has_valid();
}
inline bool VanishingPoint::valid() const {
  // @@protoc_insertion_point(field_get:caffe.VanishingPoint.valid)
  return valid_;
}
inline void VanishingPoint::set_valid(bool value) {
  set_has_valid();
  valid_ = value;
  // @@protoc_insertion_point(field_set:caffe.VanishingPoint.valid)
}

// optional float x = 2;
inline bool VanishingPoint::has_x() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void VanishingPoint::set_has_x() {
  _has_bits_[0] |= 0x00000002u;
}
inline void VanishingPoint::clear_has_x() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void VanishingPoint::clear_x() {
  x_ = 0;
  clear_has_x();
}
inline float VanishingPoint::x() const {
  // @@protoc_insertion_point(field_get:caffe.VanishingPoint.x)
  return x_;
}
inline void VanishingPoint::set_x(float value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:caffe.VanishingPoint.x)
}

// optional float y = 3;
inline bool VanishingPoint::has_y() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void VanishingPoint::set_has_y() {
  _has_bits_[0] |= 0x00000004u;
}
inline void VanishingPoint::clear_has_y() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void VanishingPoint::clear_y() {
  y_ = 0;
  clear_has_y();
}
inline float VanishingPoint::y() const {
  // @@protoc_insertion_point(field_get:caffe.VanishingPoint.y)
  return y_;
}
inline void VanishingPoint::set_y(float value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:caffe.VanishingPoint.y)
}
...
// optional .caffe.Datum car_image_datum = 1;
inline bool DrivingData::has_car_image_datum() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DrivingData::set_has_car_image_datum() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DrivingData::clear_has_car_image_datum() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DrivingData::clear_car_image_datum() {
  if (car_image_datum_ != NULL) car_image_datum_->::caffe::Datum::Clear();
  clear_has_car_image_datum();
}
inline const ::caffe::Datum& DrivingData::car_image_datum() const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.car_image_datum)
  return car_image_datum_ != NULL ? *car_image_datum_ : *default_instance_->car_image_datum_;
}
inline ::caffe::Datum* DrivingData::mutable_car_image_datum() {
  set_has_car_image_datum();
  if (car_image_datum_ == NULL) {
    car_image_datum_ = new ::caffe::Datum;
  }
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.car_image_datum)
  return car_image_datum_;
}
inline ::caffe::Datum* DrivingData::release_car_image_datum() {
  // @@protoc_insertion_point(field_release:caffe.DrivingData.car_image_datum)
  clear_has_car_image_datum();
  ::caffe::Datum* temp = car_image_datum_;
  car_image_datum_ = NULL;
  return temp;
}
inline void DrivingData::set_allocated_car_image_datum(::caffe::Datum* car_image_datum) {
  delete car_image_datum_;
  car_image_datum_ = car_image_datum;
  if (car_image_datum) {
    set_has_car_image_datum();
  } else {
    clear_has_car_image_datum();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.DrivingData.car_image_datum)
}

// optional string car_img_source = 2;
inline bool DrivingData::has_car_img_source() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DrivingData::set_has_car_img_source() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DrivingData::clear_has_car_img_source() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DrivingData::clear_car_img_source() {
  car_img_source_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_car_img_source();
}
inline const ::std::string& DrivingData::car_img_source() const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.car_img_source)
  return car_img_source_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DrivingData::set_car_img_source(const ::std::string& value) {
  set_has_car_img_source();
  car_img_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.DrivingData.car_img_source)
}
inline void DrivingData::set_car_img_source(const char* value) {
  set_has_car_img_source();
  car_img_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.DrivingData.car_img_source)
}
inline void DrivingData::set_car_img_source(const char* value, size_t size) {
  set_has_car_img_source();
  car_img_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.DrivingData.car_img_source)
}
inline ::std::string* DrivingData::mutable_car_img_source() {
  set_has_car_img_source();
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.car_img_source)
  return car_img_source_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DrivingData::release_car_img_source() {
  // @@protoc_insertion_point(field_release:caffe.DrivingData.car_img_source)
  clear_has_car_img_source();
  return car_img_source_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DrivingData::set_allocated_car_img_source(::std::string* car_img_source) {
  if (car_img_source != NULL) {
    set_has_car_img_source();
  } else {
    clear_has_car_img_source();
  }
  car_img_source_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), car_img_source);
  // @@protoc_insertion_point(field_set_allocated:caffe.DrivingData.car_img_source)
}

// optional .caffe.Datum car_mask_datum = 3;
inline bool DrivingData::has_car_mask_datum() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DrivingData::set_has_car_mask_datum() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DrivingData::clear_has_car_mask_datum() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DrivingData::clear_car_mask_datum() {
  if (car_mask_datum_ != NULL) car_mask_datum_->::caffe::Datum::Clear();
  clear_has_car_mask_datum();
}
inline const ::caffe::Datum& DrivingData::car_mask_datum() const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.car_mask_datum)
  return car_mask_datum_ != NULL ? *car_mask_datum_ : *default_instance_->car_mask_datum_;
}
inline ::caffe::Datum* DrivingData::mutable_car_mask_datum() {
  set_has_car_mask_datum();
  if (car_mask_datum_ == NULL) {
    car_mask_datum_ = new ::caffe::Datum;
  }
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.car_mask_datum)
  return car_mask_datum_;
}
inline ::caffe::Datum* DrivingData::release_car_mask_datum() {
  // @@protoc_insertion_point(field_release:caffe.DrivingData.car_mask_datum)
  clear_has_car_mask_datum();
  ::caffe::Datum* temp = car_mask_datum_;
  car_mask_datum_ = NULL;
  return temp;
}
inline void DrivingData::set_allocated_car_mask_datum(::caffe::Datum* car_mask_datum) {
  delete car_mask_datum_;
  car_mask_datum_ = car_mask_datum;
  if (car_mask_datum) {
    set_has_car_mask_datum();
  } else {
    clear_has_car_mask_datum();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.DrivingData.car_mask_datum)
}

// optional string car_mask_source = 4;
inline bool DrivingData::has_car_mask_source() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void DrivingData::set_has_car_mask_source() {
  _has_bits_[0] |= 0x00000008u;
}
inline void DrivingData::clear_has_car_mask_source() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void DrivingData::clear_car_mask_source() {
  car_mask_source_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_car_mask_source();
}
inline const ::std::string& DrivingData::car_mask_source() const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.car_mask_source)
  return car_mask_source_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DrivingData::set_car_mask_source(const ::std::string& value) {
  set_has_car_mask_source();
  car_mask_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.DrivingData.car_mask_source)
}
inline void DrivingData::set_car_mask_source(const char* value) {
  set_has_car_mask_source();
  car_mask_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.DrivingData.car_mask_source)
}
inline void DrivingData::set_car_mask_source(const char* value, size_t size) {
  set_has_car_mask_source();
  car_mask_source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.DrivingData.car_mask_source)
}
inline ::std::string* DrivingData::mutable_car_mask_source() {
  set_has_car_mask_source();
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.car_mask_source)
  return car_mask_source_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DrivingData::release_car_mask_source() {
  // @@protoc_insertion_point(field_release:caffe.DrivingData.car_mask_source)
  clear_has_car_mask_source();
  return car_mask_source_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DrivingData::set_allocated_car_mask_source(::std::string* car_mask_source) {
  if (car_mask_source != NULL) {
    set_has_car_mask_source();
  } else {
    clear_has_car_mask_source();
  }
  car_mask_source_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), car_mask_source);
  // @@protoc_insertion_point(field_set_allocated:caffe.DrivingData.car_mask_source)
}

// repeated .caffe.CarBoundingBox car_boxes = 5;
inline int DrivingData::car_boxes_size() const {
  return car_boxes_.size();
}
inline void DrivingData::clear_car_boxes() {
  car_boxes_.Clear();
}
inline const ::caffe::CarBoundingBox& DrivingData::car_boxes(int index) const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.car_boxes)
  return car_boxes_.Get(index);
}
inline ::caffe::CarBoundingBox* DrivingData::mutable_car_boxes(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.car_boxes)
  return car_boxes_.Mutable(index);
}
inline ::caffe::CarBoundingBox* DrivingData::add_car_boxes() {
  // @@protoc_insertion_point(field_add:caffe.DrivingData.car_boxes)
  return car_boxes_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::CarBoundingBox >*
DrivingData::mutable_car_boxes() {
  // @@protoc_insertion_point(field_mutable_list:caffe.DrivingData.car_boxes)
  return &car_boxes_;
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::CarBoundingBox >&
DrivingData::car_boxes() const {
  // @@protoc_insertion_point(field_list:caffe.DrivingData.car_boxes)
  return car_boxes_;
}

// repeated .caffe.VanishingPoint vanishing_point = 6;
inline int DrivingData::vanishing_point_size() const {
  return vanishing_point_.size();
}
inline void DrivingData::clear_vanishing_point() {
  vanishing_point_.Clear();
}
inline const ::caffe::VanishingPoint& DrivingData::vanishing_point(int index) const {
  // @@protoc_insertion_point(field_get:caffe.DrivingData.vanishing_point)
  return vanishing_point_.Get(index);
}
inline ::caffe::VanishingPoint* DrivingData::mutable_vanishing_point(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.DrivingData.vanishing_point)
  return vanishing_point_.Mutable(index);
}
inline ::caffe::VanishingPoint* DrivingData::add_vanishing_point() {
  // @@protoc_insertion_point(field_add:caffe.DrivingData.vanishing_point)
  return vanishing_point_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::VanishingPoint >*
DrivingData::mutable_vanishing_point() {
  // @@protoc_insertion_point(field_mutable_list:caffe.DrivingData.vanishing_point)
  return &vanishing_point_;
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::VanishingPoint >&
DrivingData::vanishing_point() const {
  // @@protoc_insertion_point(field_list:caffe.DrivingData.vanishing_point)
  return vanishing_point_;
}
...
// optional .caffe.TilingParameter tiling_param = 500;
inline bool LayerParameter::has_tiling_param() const {
  return (_has_bits_[1] & 0x00010000u) != 0;
}
inline void LayerParameter::set_has_tiling_param() {
  _has_bits_[1] |= 0x00010000u;
}
inline void LayerParameter::clear_has_tiling_param() {
  _has_bits_[1] &= ~0x00010000u;
}
inline void LayerParameter::clear_tiling_param() {
  if (tiling_param_ != NULL) tiling_param_->::caffe::TilingParameter::Clear();
  clear_has_tiling_param();
}
inline const ::caffe::TilingParameter& LayerParameter::tiling_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.tiling_param)
  return tiling_param_ != NULL ? *tiling_param_ : *default_instance_->tiling_param_;
}
inline ::caffe::TilingParameter* LayerParameter::mutable_tiling_param() {
  set_has_tiling_param();
  if (tiling_param_ == NULL) {
    tiling_param_ = new ::caffe::TilingParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.tiling_param)
  return tiling_param_;
}
inline ::caffe::TilingParameter* LayerParameter::release_tiling_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.tiling_param)
  clear_has_tiling_param();
  ::caffe::TilingParameter* temp = tiling_param_;
  tiling_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_tiling_param(::caffe::TilingParameter* tiling_param) {
  delete tiling_param_;
  tiling_param_ = tiling_param;
  if (tiling_param) {
    set_has_tiling_param();
  } else {
    clear_has_tiling_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.tiling_param)
}

// optional .caffe.DriveDataParameter drive_data_param = 501;
inline bool LayerParameter::has_drive_data_param() const {
  return (_has_bits_[1] & 0x00020000u) != 0;
}
inline void LayerParameter::set_has_drive_data_param() {
  _has_bits_[1] |= 0x00020000u;
}
inline void LayerParameter::clear_has_drive_data_param() {
  _has_bits_[1] &= ~0x00020000u;
}
inline void LayerParameter::clear_drive_data_param() {
  if (drive_data_param_ != NULL) drive_data_param_->::caffe::DriveDataParameter::Clear();
  clear_has_drive_data_param();
}
inline const ::caffe::DriveDataParameter& LayerParameter::drive_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.drive_data_param)
  return drive_data_param_ != NULL ? *drive_data_param_ : *default_instance_->drive_data_param_;
}
inline ::caffe::DriveDataParameter* LayerParameter::mutable_drive_data_param() {
  set_has_drive_data_param();
  if (drive_data_param_ == NULL) {
    drive_data_param_ = new ::caffe::DriveDataParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.drive_data_param)
  return drive_data_param_;
}
inline ::caffe::DriveDataParameter* LayerParameter::release_drive_data_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.drive_data_param)
  clear_has_drive_data_param();
  ::caffe::DriveDataParameter* temp = drive_data_param_;
  drive_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_drive_data_param(::caffe::DriveDataParameter* drive_data_param) {
  delete drive_data_param_;
  drive_data_param_ = drive_data_param;
  if (drive_data_param) {
    set_has_drive_data_param();
  } else {
    clear_has_drive_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.drive_data_param)
}
...
// optional int32 tile_dim = 1;
inline bool TilingParameter::has_tile_dim() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void TilingParameter::set_has_tile_dim() {
  _has_bits_[0] |= 0x00000001u;
}
inline void TilingParameter::clear_has_tile_dim() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void TilingParameter::clear_tile_dim() {
  tile_dim_ = 0;
  clear_has_tile_dim();
}
inline ::google::protobuf::int32 TilingParameter::tile_dim() const {
  // @@protoc_insertion_point(field_get:caffe.TilingParameter.tile_dim)
  return tile_dim_;
}
inline void TilingParameter::set_tile_dim(::google::protobuf::int32 value) {
  set_has_tile_dim();
  tile_dim_ = value;
  // @@protoc_insertion_point(field_set:caffe.TilingParameter.tile_dim)
}
...
// optional float shrink_prob_factor = 1 [default = 1];
inline bool DriveDataParameter::has_shrink_prob_factor() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DriveDataParameter::set_has_shrink_prob_factor() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DriveDataParameter::clear_has_shrink_prob_factor() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DriveDataParameter::clear_shrink_prob_factor() {
  shrink_prob_factor_ = 1;
  clear_has_shrink_prob_factor();
}
inline float DriveDataParameter::shrink_prob_factor() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.shrink_prob_factor)
  return shrink_prob_factor_;
}
inline void DriveDataParameter::set_shrink_prob_factor(float value) {
  set_has_shrink_prob_factor();
  shrink_prob_factor_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.shrink_prob_factor)
}

// optional float unrecognize_factor = 2 [default = 0.9];
inline bool DriveDataParameter::has_unrecognize_factor() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DriveDataParameter::set_has_unrecognize_factor() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DriveDataParameter::clear_has_unrecognize_factor() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DriveDataParameter::clear_unrecognize_factor() {
  unrecognize_factor_ = 0.9f;
  clear_has_unrecognize_factor();
}
inline float DriveDataParameter::unrecognize_factor() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.unrecognize_factor)
  return unrecognize_factor_;
}
inline void DriveDataParameter::set_unrecognize_factor(float value) {
  set_has_unrecognize_factor();
  unrecognize_factor_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.unrecognize_factor)
}

// optional uint32 crop_num = 3 [default = 4];
inline bool DriveDataParameter::has_crop_num() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DriveDataParameter::set_has_crop_num() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DriveDataParameter::clear_has_crop_num() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DriveDataParameter::clear_crop_num() {
  crop_num_ = 4u;
  clear_has_crop_num();
}
inline ::google::protobuf::uint32 DriveDataParameter::crop_num() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.crop_num)
  return crop_num_;
}
inline void DriveDataParameter::set_crop_num(::google::protobuf::uint32 value) {
  set_has_crop_num();
  crop_num_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.crop_num)
}

// optional float random_crop_ratio = 4 [default = 0];
inline bool DriveDataParameter::has_random_crop_ratio() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void DriveDataParameter::set_has_random_crop_ratio() {
  _has_bits_[0] |= 0x00000008u;
}
inline void DriveDataParameter::clear_has_random_crop_ratio() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void DriveDataParameter::clear_random_crop_ratio() {
  random_crop_ratio_ = 0;
  clear_has_random_crop_ratio();
}
inline float DriveDataParameter::random_crop_ratio() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.random_crop_ratio)
  return random_crop_ratio_;
}
inline void DriveDataParameter::set_random_crop_ratio(float value) {
  set_has_random_crop_ratio();
  random_crop_ratio_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.random_crop_ratio)
}

// optional float resize = 5 [default = 1];
inline bool DriveDataParameter::has_resize() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DriveDataParameter::set_has_resize() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DriveDataParameter::clear_has_resize() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DriveDataParameter::clear_resize() {
  resize_ = 1;
  clear_has_resize();
}
inline float DriveDataParameter::resize() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.resize)
  return resize_;
}
inline void DriveDataParameter::set_resize(float value) {
  set_has_resize();
  resize_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.resize)
}

// optional float scale = 6 [default = 1];
inline bool DriveDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void DriveDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00000020u;
}
inline void DriveDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void DriveDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float DriveDataParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.scale)
  return scale_;
}
inline void DriveDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.scale)
}

// optional uint32 cropped_height = 7 [default = 480];
inline bool DriveDataParameter::has_cropped_height() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void DriveDataParameter::set_has_cropped_height() {
  _has_bits_[0] |= 0x00000040u;
}
inline void DriveDataParameter::clear_has_cropped_height() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void DriveDataParameter::clear_cropped_height() {
  cropped_height_ = 480u;
  clear_has_cropped_height();
}
inline ::google::protobuf::uint32 DriveDataParameter::cropped_height() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.cropped_height)
  return cropped_height_;
}
inline void DriveDataParameter::set_cropped_height(::google::protobuf::uint32 value) {
  set_has_cropped_height();
  cropped_height_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.cropped_height)
}

// optional uint32 cropped_width = 8 [default = 640];
inline bool DriveDataParameter::has_cropped_width() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void DriveDataParameter::set_has_cropped_width() {
  _has_bits_[0] |= 0x00000080u;
}
inline void DriveDataParameter::clear_has_cropped_width() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void DriveDataParameter::clear_cropped_width() {
  cropped_width_ = 640u;
  clear_has_cropped_width();
}
inline ::google::protobuf::uint32 DriveDataParameter::cropped_width() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.cropped_width)
  return cropped_width_;
}
inline void DriveDataParameter::set_cropped_width(::google::protobuf::uint32 value) {
  set_has_cropped_width();
  cropped_width_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.cropped_width)
}

// optional int32 tiling_width = 9 [default = 20];
inline bool DriveDataParameter::has_tiling_width() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void DriveDataParameter::set_has_tiling_width() {
  _has_bits_[0] |= 0x00000100u;
}
inline void DriveDataParameter::clear_has_tiling_width() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void DriveDataParameter::clear_tiling_width() {
  tiling_width_ = 20;
  clear_has_tiling_width();
}
inline ::google::protobuf::int32 DriveDataParameter::tiling_width() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.tiling_width)
  return tiling_width_;
}
inline void DriveDataParameter::set_tiling_width(::google::protobuf::int32 value) {
  set_has_tiling_width();
  tiling_width_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.tiling_width)
}

// optional int32 tiling_height = 10 [default = 15];
inline bool DriveDataParameter::has_tiling_height() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void DriveDataParameter::set_has_tiling_height() {
  _has_bits_[0] |= 0x00000200u;
}
inline void DriveDataParameter::clear_has_tiling_height() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void DriveDataParameter::clear_tiling_height() {
  tiling_height_ = 15;
  clear_has_tiling_height();
}
inline ::google::protobuf::int32 DriveDataParameter::tiling_height() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.tiling_height)
  return tiling_height_;
}
inline void DriveDataParameter::set_tiling_height(::google::protobuf::int32 value) {
  set_has_tiling_height();
  tiling_height_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.tiling_height)
}

// optional int32 label_resolution = 11 [default = 8];
inline bool DriveDataParameter::has_label_resolution() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void DriveDataParameter::set_has_label_resolution() {
  _has_bits_[0] |= 0x00000400u;
}
inline void DriveDataParameter::clear_has_label_resolution() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void DriveDataParameter::clear_label_resolution() {
  label_resolution_ = 8;
  clear_has_label_resolution();
}
inline ::google::protobuf::int32 DriveDataParameter::label_resolution() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.label_resolution)
  return label_resolution_;
}
inline void DriveDataParameter::set_label_resolution(::google::protobuf::int32 value) {
  set_has_label_resolution();
  label_resolution_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.label_resolution)
}

// optional int32 catalog_resolution = 12 [default = 2];
inline bool DriveDataParameter::has_catalog_resolution() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void DriveDataParameter::set_has_catalog_resolution() {
  _has_bits_[0] |= 0x00000800u;
}
inline void DriveDataParameter::clear_has_catalog_resolution() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void DriveDataParameter::clear_catalog_resolution() {
  catalog_resolution_ = 2;
  clear_has_catalog_resolution();
}
inline ::google::protobuf::int32 DriveDataParameter::catalog_resolution() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.catalog_resolution)
  return catalog_resolution_;
}
inline void DriveDataParameter::set_catalog_resolution(::google::protobuf::int32 value) {
  set_has_catalog_resolution();
  catalog_resolution_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.catalog_resolution)
}

// optional int32 catalog_number = 13 [default = 150];
inline bool DriveDataParameter::has_catalog_number() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void DriveDataParameter::set_has_catalog_number() {
  _has_bits_[0] |= 0x00001000u;
}
inline void DriveDataParameter::clear_has_catalog_number() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void DriveDataParameter::clear_catalog_number() {
  catalog_number_ = 150;
  clear_has_catalog_number();
}
inline ::google::protobuf::int32 DriveDataParameter::catalog_number() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.catalog_number)
  return catalog_number_;
}
inline void DriveDataParameter::set_catalog_number(::google::protobuf::int32 value) {
  set_has_catalog_number();
  catalog_number_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.catalog_number)
}

// optional float resize_max = 14 [default = 5];
inline bool DriveDataParameter::has_resize_max() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void DriveDataParameter::set_has_resize_max() {
  _has_bits_[0] |= 0x00002000u;
}
inline void DriveDataParameter::clear_has_resize_max() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void DriveDataParameter::clear_resize_max() {
  resize_max_ = 5;
  clear_has_resize_max();
}
inline float DriveDataParameter::resize_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.resize_max)
  return resize_max_;
}
inline void DriveDataParameter::set_resize_max(float value) {
  set_has_resize_max();
  resize_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.resize_max)
}

// optional float resize_min = 15 [default = 0.1];
inline bool DriveDataParameter::has_resize_min() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void DriveDataParameter::set_has_resize_min() {
  _has_bits_[0] |= 0x00004000u;
}
inline void DriveDataParameter::clear_has_resize_min() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void DriveDataParameter::clear_resize_min() {
  resize_min_ = 0.1f;
  clear_has_resize_min();
}
inline float DriveDataParameter::resize_min() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.resize_min)
  return resize_min_;
}
inline void DriveDataParameter::set_resize_min(float value) {
  set_has_resize_min();
  resize_min_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.resize_min)
}

// optional float reco_max = 16 [default = 170];
inline bool DriveDataParameter::has_reco_max() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void DriveDataParameter::set_has_reco_max() {
  _has_bits_[0] |= 0x00008000u;
}
inline void DriveDataParameter::clear_has_reco_max() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void DriveDataParameter::clear_reco_max() {
  reco_max_ = 170;
  clear_has_reco_max();
}
inline float DriveDataParameter::reco_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.reco_max)
  return reco_max_;
}
inline void DriveDataParameter::set_reco_max(float value) {
  set_has_reco_max();
  reco_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.reco_max)
}

// optional float reco_min = 17 [default = 40];
inline bool DriveDataParameter::has_reco_min() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void DriveDataParameter::set_has_reco_min() {
  _has_bits_[0] |= 0x00010000u;
}
inline void DriveDataParameter::clear_has_reco_min() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void DriveDataParameter::clear_reco_min() {
  reco_min_ = 40;
  clear_has_reco_min();
}
inline float DriveDataParameter::reco_min() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.reco_min)
  return reco_min_;
}
inline void DriveDataParameter::set_reco_min(float value) {
  set_has_reco_min();
  reco_min_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.reco_min)
}

// optional float train_max = 18 [default = 200];
inline bool DriveDataParameter::has_train_max() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void DriveDataParameter::set_has_train_max() {
  _has_bits_[0] |= 0x00020000u;
}
inline void DriveDataParameter::clear_has_train_max() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void DriveDataParameter::clear_train_max() {
  train_max_ = 200;
  clear_has_train_max();
}
inline float DriveDataParameter::train_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.train_max)
  return train_max_;
}
inline void DriveDataParameter::set_train_max(float value) {
  set_has_train_max();
  train_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.train_max)
}

// optional float train_min = 19 [default = 20];
inline bool DriveDataParameter::has_train_min() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void DriveDataParameter::set_has_train_min() {
  _has_bits_[0] |= 0x00040000u;
}
inline void DriveDataParameter::clear_has_train_min() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void DriveDataParameter::clear_train_min() {
  train_min_ = 20;
  clear_has_train_min();
}
inline float DriveDataParameter::train_min() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.train_min)
  return train_min_;
}
inline void DriveDataParameter::set_train_min(float value) {
  set_has_train_min();
  train_min_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.train_min)
}

// optional string genlist_file = 20 [default = ""];
inline bool DriveDataParameter::has_genlist_file() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void DriveDataParameter::set_has_genlist_file() {
  _has_bits_[0] |= 0x00080000u;
}
inline void DriveDataParameter::clear_has_genlist_file() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void DriveDataParameter::clear_genlist_file() {
  genlist_file_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_genlist_file();
}
inline const ::std::string& DriveDataParameter::genlist_file() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.genlist_file)
  return genlist_file_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DriveDataParameter::set_genlist_file(const ::std::string& value) {
  set_has_genlist_file();
  genlist_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.genlist_file)
}
inline void DriveDataParameter::set_genlist_file(const char* value) {
  set_has_genlist_file();
  genlist_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.DriveDataParameter.genlist_file)
}
inline void DriveDataParameter::set_genlist_file(const char* value, size_t size) {
  set_has_genlist_file();
  genlist_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.DriveDataParameter.genlist_file)
}
inline ::std::string* DriveDataParameter::mutable_genlist_file() {
  set_has_genlist_file();
  // @@protoc_insertion_point(field_mutable:caffe.DriveDataParameter.genlist_file)
  return genlist_file_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DriveDataParameter::release_genlist_file() {
  // @@protoc_insertion_point(field_release:caffe.DriveDataParameter.genlist_file)
  clear_has_genlist_file();
  return genlist_file_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DriveDataParameter::set_allocated_genlist_file(::std::string* genlist_file) {
  if (genlist_file != NULL) {
    set_has_genlist_file();
  } else {
    clear_has_genlist_file();
  }
  genlist_file_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), genlist_file);
  // @@protoc_insertion_point(field_set_allocated:caffe.DriveDataParameter.genlist_file)
}

// optional float gen_rate = 21 [default = 0.5];
inline bool DriveDataParameter::has_gen_rate() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void DriveDataParameter::set_has_gen_rate() {
  _has_bits_[0] |= 0x00100000u;
}
inline void DriveDataParameter::clear_has_gen_rate() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void DriveDataParameter::clear_gen_rate() {
  gen_rate_ = 0.5f;
  clear_has_gen_rate();
}
inline float DriveDataParameter::gen_rate() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.gen_rate)
  return gen_rate_;
}
inline void DriveDataParameter::set_gen_rate(float value) {
  set_has_gen_rate();
  gen_rate_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.gen_rate)
}

// optional float blur_max = 22 [default = 15];
inline bool DriveDataParameter::has_blur_max() const {
  return (_has_bits_[0] & 0x00200000u) != 0;
}
inline void DriveDataParameter::set_has_blur_max() {
  _has_bits_[0] |= 0x00200000u;
}
inline void DriveDataParameter::clear_has_blur_max() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void DriveDataParameter::clear_blur_max() {
  blur_max_ = 15;
  clear_has_blur_max();
}
inline float DriveDataParameter::blur_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.blur_max)
  return blur_max_;
}
inline void DriveDataParameter::set_blur_max(float value) {
  set_has_blur_max();
  blur_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.blur_max)
}

// optional float noise_max = 23 [default = 0.5];
inline bool DriveDataParameter::has_noise_max() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void DriveDataParameter::set_has_noise_max() {
  _has_bits_[0] |= 0x00400000u;
}
inline void DriveDataParameter::clear_has_noise_max() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void DriveDataParameter::clear_noise_max() {
  noise_max_ = 0.5f;
  clear_has_noise_max();
}
inline float DriveDataParameter::noise_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.noise_max)
  return noise_max_;
}
inline void DriveDataParameter::set_noise_max(float value) {
  set_has_noise_max();
  noise_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.noise_max)
}

// optional float gamma_max = 24 [default = 0.69314718];
inline bool DriveDataParameter::has_gamma_max() const {
  return (_has_bits_[0] & 0x00800000u) != 0;
}
inline void DriveDataParameter::set_has_gamma_max() {
  _has_bits_[0] |= 0x00800000u;
}
inline void DriveDataParameter::clear_has_gamma_max() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void DriveDataParameter::clear_gamma_max() {
  gamma_max_ = 0.69314718f;
  clear_has_gamma_max();
}
inline float DriveDataParameter::gamma_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.gamma_max)
  return gamma_max_;
}
inline void DriveDataParameter::set_gamma_max(float value) {
  set_has_gamma_max();
  gamma_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.gamma_max)
}

// optional float k_max = 25 [default = 0.1];
inline bool DriveDataParameter::has_k_max() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void DriveDataParameter::set_has_k_max() {
  _has_bits_[0] |= 0x01000000u;
}
inline void DriveDataParameter::clear_has_k_max() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void DriveDataParameter::clear_k_max() {
  k_max_ = 0.1f;
  clear_has_k_max();
}
inline float DriveDataParameter::k_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.k_max)
  return k_max_;
}
inline void DriveDataParameter::set_k_max(float value) {
  set_has_k_max();
  k_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.k_max)
}

// optional float y0_max = 26 [default = 0.1];
inline bool DriveDataParameter::has_y0_max() const {
  return (_has_bits_[0] & 0x02000000u) != 0;
}
inline void DriveDataParameter::set_has_y0_max() {
  _has_bits_[0] |= 0x02000000u;
}
inline void DriveDataParameter::clear_has_y0_max() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void DriveDataParameter::clear_y0_max() {
  y0_max_ = 0.1f;
  clear_has_y0_max();
}
inline float DriveDataParameter::y0_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.y0_max)
  return y0_max_;
}
inline void DriveDataParameter::set_y0_max(float value) {
  set_has_y0_max();
  y0_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.y0_max)
}

// optional float shrink_max = 27 [default = 0.5];
inline bool DriveDataParameter::has_shrink_max() const {
  return (_has_bits_[0] & 0x04000000u) != 0;
}
inline void DriveDataParameter::set_has_shrink_max() {
  _has_bits_[0] |= 0x04000000u;
}
inline void DriveDataParameter::clear_has_shrink_max() {
  _has_bits_[0] &= ~0x04000000u;
}
inline void DriveDataParameter::clear_shrink_max() {
  shrink_max_ = 0.5f;
  clear_has_shrink_max();
}
inline float DriveDataParameter::shrink_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.shrink_max)
  return shrink_max_;
}
inline void DriveDataParameter::set_shrink_max(float value) {
  set_has_shrink_max();
  shrink_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.shrink_max)
}

// optional float slip_max = 28 [default = 0.2];
inline bool DriveDataParameter::has_slip_max() const {
  return (_has_bits_[0] & 0x08000000u) != 0;
}
inline void DriveDataParameter::set_has_slip_max() {
  _has_bits_[0] |= 0x08000000u;
}
inline void DriveDataParameter::clear_has_slip_max() {
  _has_bits_[0] &= ~0x08000000u;
}
inline void DriveDataParameter::clear_slip_max() {
  slip_max_ = 0.2f;
  clear_has_slip_max();
}
inline float DriveDataParameter::slip_max() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.slip_max)
  return slip_max_;
}
inline void DriveDataParameter::set_slip_max(float value) {
  set_has_slip_max();
  slip_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.slip_max)
}

// optional float gen_scale = 29 [default = 1.5];
inline bool DriveDataParameter::has_gen_scale() const {
  return (_has_bits_[0] & 0x10000000u) != 0;
}
inline void DriveDataParameter::set_has_gen_scale() {
  _has_bits_[0] |= 0x10000000u;
}
inline void DriveDataParameter::clear_has_gen_scale() {
  _has_bits_[0] &= ~0x10000000u;
}
inline void DriveDataParameter::clear_gen_scale() {
  gen_scale_ = 1.5f;
  clear_has_gen_scale();
}
inline float DriveDataParameter::gen_scale() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.gen_scale)
  return gen_scale_;
}
inline void DriveDataParameter::set_gen_scale(float value) {
  set_has_gen_scale();
  gen_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.gen_scale)
}

// optional bool use_mask = 30 [default = false];
inline bool DriveDataParameter::has_use_mask() const {
  return (_has_bits_[0] & 0x20000000u) != 0;
}
inline void DriveDataParameter::set_has_use_mask() {
  _has_bits_[0] |= 0x20000000u;
}
inline void DriveDataParameter::clear_has_use_mask() {
  _has_bits_[0] &= ~0x20000000u;
}
inline void DriveDataParameter::clear_use_mask() {
  use_mask_ = false;
  clear_has_use_mask();
}
inline bool DriveDataParameter::use_mask() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.use_mask)
  return use_mask_;
}
inline void DriveDataParameter::set_use_mask(bool value) {
  set_has_use_mask();
  use_mask_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.use_mask)
}
